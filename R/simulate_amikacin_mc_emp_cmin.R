...
#' 
#' @examples \dontrun{
#' simulate_amikacin_mc_emp_cmin(PATID = "Anonymous", 
#'     AGE = 65, HEIGHT = 175, 
#'     WEIGHT = 75, GENDER = "Male", 
#'     MODEL = "Saez Fernandez et al. (2019) - General ward", 
#'     CREATININE = 1, MIC = 1, 
#'     CMIN = 2, LOADINGDOSE = "No", 
#'     REGIMENS = list(list(
#'         set = "REGIMEN", 
#'         DOSE = 100, INTERVAL = 8, 
#'         TINF = 0.5), 
...
simulate_amikacin_mc_emp_cmin <- function(PATID, AGE, HEIGHT, WEIGHT, GENDER, MODEL, CREATININE, MIC, CMIN, LOADINGDOSE, REGIMENS) {
  ...
  ## API call
  simulate("amikacin-mc-emp-cmin", PATID = PATID, AGE = AGE, HEIGHT = HEIGHT, WEIGHT = WEIGHT, GENDER = GENDER, MODEL = MODEL, CREATININE = CREATININE, MIC = MIC, CMIN = CMIN, LOADINGDOSE = LOADINGDOSE, REGIMENS = REGIMENS)
}
