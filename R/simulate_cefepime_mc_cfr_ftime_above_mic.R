...
#' 
#' @examples \dontrun{
#' simulate_cefepime_mc_cfr_ftime_above_mic(PATID = "Anonymous", 
#'     AGE = 75, HEIGHT = 160, 
...
simulate_cefepime_mc_cfr_ftime_above_mic <- function(PATID, AGE, HEIGHT, WEIGHT, GENDER, CREATININE, MODEL, PCTABOVEMIC, CRCLCAP, REGIMENS, MICDISTR) {
  ...
  ## API call
  simulate("cefepime-mc-cfr-ftime-above-mic", PATID = PATID, AGE = AGE, HEIGHT = HEIGHT, WEIGHT = WEIGHT, GENDER = GENDER, CREATININE = CREATININE, MODEL = MODEL, PCTABOVEMIC = PCTABOVEMIC, CRCLCAP = CRCLCAP, REGIMENS = REGIMENS, MICDISTR = MICDISTR)
}
