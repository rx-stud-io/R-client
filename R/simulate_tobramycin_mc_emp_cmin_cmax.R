...
#' 
#' @examples \dontrun{
#' simulate_tobramycin_mc_emp_cmin_cmax(PATID = "Anonymous", 
#'     AGE = 65, HEIGHT = 175, 
...
simulate_tobramycin_mc_emp_cmin_cmax <- function(PATID, AGE, HEIGHT, WEIGHT, GENDER, MODEL, CREATININE, MIC, CMIN, CMAX, LOADINGDOSE, REGIMENS) {
  ...
  ## API call
  simulate("tobramycin-mc-emp-cmin-cmax", PATID = PATID, AGE = AGE, HEIGHT = HEIGHT, WEIGHT = WEIGHT, GENDER = GENDER, MODEL = MODEL, CREATININE = CREATININE, MIC = MIC, CMIN = CMIN, CMAX = CMAX, LOADINGDOSE = LOADINGDOSE, REGIMENS = REGIMENS)
}
