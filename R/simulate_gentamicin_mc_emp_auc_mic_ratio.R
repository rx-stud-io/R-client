...
#' 
#' @examples \dontrun{
#' simulate_gentamicin_mc_emp_auc_mic_ratio(PATID = "Anonymous", 
#'     AGE = 65, HEIGHT = 175, 
...
simulate_gentamicin_mc_emp_auc_mic_ratio <- function(PATID, AGE, HEIGHT, WEIGHT, GENDER, MODEL, CREATININE, MIC, AUCPERMIC, LOADINGDOSE, REGIMENS) {
  ...
  ## API call
  simulate("gentamicin-mc-emp-auc-mic-ratio", PATID = PATID, AGE = AGE, HEIGHT = HEIGHT, WEIGHT = WEIGHT, GENDER = GENDER, MODEL = MODEL, CREATININE = CREATININE, MIC = MIC, AUCPERMIC = AUCPERMIC, LOADINGDOSE = LOADINGDOSE, REGIMENS = REGIMENS)
}
